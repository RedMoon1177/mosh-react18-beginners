...
function App() {
  ...
  const [expenses, setExpenses] = useState([
    { id: 1, description: "Rice", amount: 10, category: "Groceries" },
    { id: 2, description: "Coca", amount: 5, category: "Groceries" },
    { id: 3, description: "Red Car", amount: 15, category: "Entertainment" },
    { id: 4, description: "T-Shirt", amount: 30, category: "Utilities" },
    { id: 5, description: "Chair", amount: 10, category: "Utilities" },
  ]);
